...
import type {Route} from './+types/shop-artifacts';
...
const HANDLE = 'artifacts';

export const meta: Route.MetaFunction = () => {
  return [{title: 'Circuittelligence | Shop — Artifacts'}];
};
...
export default function ShopArtifacts() {
  const {collection} = useLoaderData<typeof loader>();

  return (
    <div className="department">
      <DepartmentHero
        title={collection?.title ?? 'ARTIFACTS'}
        description={
          collection?.description ??
          'Recovered hardware and limited deployments.'
        }
